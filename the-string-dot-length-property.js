...
let lengthOne = stringOne.length;   // Length of stringOne is 15
let lengthTwo = stringTwo.length;   // Length of stringTwo is 10
let lengthThree = stringThree.length; // Length of stringThree is 0
